...
@register_model("unity_conformer_modified")
class UnityConformerModelModified(UnityConformerModel):
    """
...
@register_model_architecture(
    model_name="unity_conformer_modified", arch_name="unity_conformer_modified"
)
def unity_conformer_modified_architecture_base(args):
