...
class ConvolutionModule(torch.nn.Module):
    ...
    def __init__(
        ...
        # conv_mask=torch.ones_like(self.depthwise_conv.weight.data).detach()
        # conv_mask[:,:,conv_mask.size(-1)//2+1:]=0
        # self.depthwise_conv.weight.data=self.depthwise_conv.weight.data*conv_mask
...
class UniConformerEncoderLayer(torch.nn.Module):
    ...
    def __init__(
        ...
        super(UniConformerEncoderLayer, self).__init__()
