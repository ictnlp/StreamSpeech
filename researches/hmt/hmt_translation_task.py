...
@dataclass
class HmtTranslationConfig(FairseqDataclass):
...
class HmtTranslationTask(FairseqTask):
    ...
    cfg: HmtTranslationConfig

    def __init__(self, cfg: HmtTranslationConfig, src_dict, tgt_dict):
        super().__init__(cfg)
        self.src_dict = src_dict
        self.tgt_dict = tgt_dict

    @classmethod
    def setup_task(cls, cfg: HmtTranslationConfig, **kwargs):
    ...
    def build_generator(
        ...
        if seq_gen_cls is None:
            if getattr(args, "print_alignment", False):
                ...
                seq_gen_cls = HmtSequenceGenerator
        """
        seq_gen_cls = HmtSimSequenceGenerator
        return seq_gen_cls(
            models,
            self.target_dictionary,
