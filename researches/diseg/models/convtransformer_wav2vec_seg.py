...
class ConvTransformerSegEncoder(FairseqEncoder):
    ...
    def forward(self, src_tokens, src_lengths, mode, update_num=None, seg_speech=False):
...
@register_model_architecture(
    "convtransformer_wav2vec_seg", "convtransformer_espnet_wav2vec_seg"
)
...
@register_model_architecture(
    "convtransformer_wav2vec_seg", "convtransformer_espnet_base_wav2vec_seg"
)
