...
class WaitSegMultiheadAttention(FairseqIncrementalDecoder):
    ...
    def forward(
        ...
        if saved_state is not None:
            ...
            key_padding_mask = WaitSegMultiheadAttention._append_prev_key_padding_mask(
        ...
        if training_lagging_seg is not None:
            if seg_prob is not None:
                waitseg_mask = self.build_waitseg_mask(
                    attn_weights, training_lagging_seg, seg_prob
                )
